...
Thanks to HN user ufo who [pointed out](https://news.ycombinator.com/item?id=21579483) you don't need a lambda to adapt `std::toupper` for use in `std::transform`.
