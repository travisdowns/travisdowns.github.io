...
When you're done, join the discussion on [Hacker News](https://news.ycombinator.com/item?id=22101452).
{: .warning}
...
Thanks to [Matt Godbolt](https://twitter.com/mattgodbolt) for creating [Godbolt](https://godbolt.org/), without which this type of investigation would be much more painful and often wouldn't happen at all.
